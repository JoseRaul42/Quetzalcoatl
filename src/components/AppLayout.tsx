...
import { Settings, Database, Terminal, BarChart, MessageSquare, Clock, Computer, Coins, Server, CloudLightning, Cpu, Feather } from "lucide-react";
        ...
        <Sidebar>
          <SidebarHeader className="flex items-center justify-between p-4">
            <div className="flex items-center">
              <Feather className="h-6 w-6 text-sidebar-primary mr-2" />
              <h1 className="text-lg font-bold">Quetzalcoatl</h1>
            </div>
          </SidebarHeader>
